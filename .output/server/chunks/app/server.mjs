import { hasInjectionContext, getCurrentInstance, defineComponent, h, inject, onUnmounted, computed, watch, Fragment, useSSRContext, createApp, reactive, ref, effectScope, isRef, isReactive, toRaw, shallowRef, getCurrentScope, onScopeDispose, nextTick, provide, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, toRef, shallowReactive, isReadonly, toRefs, markRaw, Text, defineAsyncComponent, isShallow, mergeProps, Suspense, Transition } from 'vue';
import { f as useRuntimeConfig$1, i as createError$1, $ as $fetch, m as sanitizeStatusCode, n as createHooks, o as getRequestHeaders, p as parse$1, q as getRequestHeader, r as destr, t as isEqual$1, v as setCookie, x as getCookie, y as deleteCookie } from '../nitro/node-server.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-7376c7c5.mjs').then((m) => m.default || m)
  }
];
...
function getLocaleCookie() {
  ...
  const localeCookie = useCookie(detect.cookieKey);
...
function setLocaleCookie(locale) {
  const { useCookie: useCookie$1, cookieKey, cookieDomain, cookieSecure, cookieCrossOrigin } = nuxtI18nOptions.detectBrowserLanguage || nuxtI18nOptionsDefault.detectBrowserLanguage;
  if (!useCookie$1) {
    return;
  }
...
const i18n_huatSqtcYP = /* @__PURE__ */ defineNuxtPlugin({
  name: "i18n:plugin",
    ...
    extendI18n(i18n, {
      ...
      hooks: {
        onExtendComposer(composer) {
          ...
          composer.getLocaleCookie = () => getLocaleCookie();
          composer.setLocaleCookie = (locale) => setLocaleCookie(locale);
...
const layouts = {
  default: () => import('./_nuxt/default-513ad819.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-b8afae31.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-18a7e779.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-96818444.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { LayoutMetaSymbol as L, PageRouteSymbol as P, _export_sfc as _, parseQuery as a, withoutTrailingSlash as b, createError as c, appPageTransition as d, entry$1 as default, _wrapIf as e, appKeepalive as f, useNuxtApp as g, hasProtocol as h, defineStore as i, navigateTo as n, parseURL as p, useRouter as u, withTrailingSlash as w };
