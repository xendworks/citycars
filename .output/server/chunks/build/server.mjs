import { hasInjectionContext, getCurrentInstance, inject, ref, reactive, effectScope, isRef, isReactive, toRaw, getCurrentScope, onScopeDispose, watch, nextTick, toRefs, markRaw, computed, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, defineAsyncComponent, unref, shallowReactive, createApp, toRef, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, isReadonly, isShallow, mergeProps, Suspense, useSSRContext } from 'vue';
...
import { h as hasProtocol, i as isScriptProtocol, k as joinURL, w as withQuery, s as sanitizeStatusCode, l as getContext, m as createHooks, n as executeAsync, c as createError$1, o as withBase, p as destr, t as toRouteMatcher, q as createRouter$1, r as defu } from '../nitro/nitro.mjs';
...
const _ht = class _ht {
  ...
  async formData() {
    ...
    const { toFormData: a } = await import('./multipart-parser-Cq-T4dgm.mjs');
...
const unhead_pHocHVgY5_DPTF22gsgIkhLjUme2IjlKQ5sdHXvI8_k = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  {
    ...
    component: () => import('./index-D3JoEMFH.mjs')
  },
  {
    name: "quote",
    path: "/quote",
    component: () => import('./quote--TkbruF7.mjs')
  },
  {
    name: "contact-us",
    path: "/contact-us",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./contact-us-BueV9tmb.mjs')
  },
  {
    name: "SamplePage",
    path: "/SamplePage",
    component: () => import('./SamplePage-BUvM7Yc1.mjs')
  },
  {
    name: "airport-taxis",
    path: "/airport-taxis",
    meta: __nuxt_page_meta$1 || {},
    component: () => import('./airport-taxis-CFyCD795.mjs')
  },
  {
    name: "wheel-chair-taxis",
    path: "/wheel-chair-taxis",
    meta: __nuxt_page_meta || {},
    component: () => import('./wheel-chair-taxis-DticNRV7.mjs')
  }
];
...
const revive_payload_server_U8Onuo6Bo_6enz9m76wwiulhI1YP2S6SgFPUNH35RpA = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_pHocHVgY5_DPTF22gsgIkhLjUme2IjlKQ5sdHXvI8_k,
  plugin$1,
  revive_payload_server_U8Onuo6Bo_6enz9m76wwiulhI1YP2S6SgFPUNH35RpA,
  plugin,
  components_plugin_z4hgvsiddfKkfXTP6M8M4zG5Cb7sGnDhcryKVM45Di4
];
const layouts = {
  default: defineAsyncComponent(() => import('./default-BahSXJUw.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DlsQKFV8.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BLoncJ-1.mjs'));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.17.7_@netlify+blobs@9.1.2_@parcel+watcher@2.5.1_@types+node@22.16.5_@vue+compiler-sfc@_yr355xkq3ej4mz2syphokl6wbu/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.17.7_@netlify+blobs@9.1.2_@parcel+watcher@2.5.1_@types+node@22.16.5_@vue+compiler-sfc@_yr355xkq3ej4mz2syphokl6wbu/node_modules/nuxt/dist/app/components/nuxt-root.vue");
...
export { LayoutMetaSymbol as L, PageRouteSymbol as P, Yr as Y, Zt as Z, _export_sfc as _, useRouter as a, useRuntimeConfig as b, nuxtLinkDefaults as c, defineStore as d, entry$1 as default, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useNuxtApp as u };
