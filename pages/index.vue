    ...
    <div class="relative z-10">
      ...
      <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
          <h2 class="text-3xl font-bold text-center mb-16">Why ride with City Cars?</h2>

          <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
            <!-- Cheaper Prices -->
            <div class="text-center">
              <div class="flex justify-center mb-6">
                <div class="rounded-full bg-amber-200 p-6 inline-block">
                  <span class="text-amber-500 text-5xl font-bold">£</span>
                </div>
              </div>
              <h3 class="text-2xl font-bold mb-4">Cheaper Prices</h3>
              <p class="text-gray-700">
                Our taxi services offer competitive pricing, ensuring great value for your money. Enjoy a
                comfortable ride at affordable rates, perfect for both short trips and long journeys.
              </p>
            </div>
            ...
            <div class="text-center">
              <div class="flex justify-center mb-6">
                <div class="rounded-full bg-amber-200 p-6 inline-block">
                  <span class="text-amber-500 text-2xl font-bold">BOOK</span>
                </div>
              </div>
              <h3 class="text-2xl font-bold mb-4">Easy Online Booking</h3>
              <p class="text-gray-700">
        ...
        <div class="container mx-auto px-4">
          ...
          <div class="mx-auto">
            ...
            <div class="flex flex-wrap justify-center mb-6 md:mb-8 bg-gray-100 rounded-xl p-1 md:p-2">
              <button v-for="(tab, index) in taxiTypes" :key="tab.id" @click="activeTaxiTab = tab.id" :class="[
              ...
              <div v-for="tab in taxiTypes" :key="tab.id" v-show="activeTaxiTab === tab.id" class="p-4 md:p-8">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 items-start">
                  ...
                  <div class="space-y-4 md:space-y-6">
                    <div class="relative">
                      <div
                        class="w-full h-48 md:h-64 bg-gradient-to-br from-amber-100 to-amber-200 rounded-lg md:rounded-xl flex items-center justify-center overflow-hidden">
                  ...
                  <div class="space-y-4 md:space-y-6">
                    ...
                    <div class="space-y-2 md:space-y-3">
                      ...
                      <ul class="space-y-1 md:space-y-2">
                        <li v-for="feature in tab.included" :key="feature"
                          class="flex items-center space-x-2 md:space-x-3">
                          <svg class="w-4 h-4 md:w-5 md:h-5 text-green-500 flex-shrink-0" fill="none"
                    ...
                    <!-- CTA Button -->
                    <button
                      class="w-full bg-amber-500 hover:bg-amber-600 text-white py-3 md:py-4 px-4 md:px-6 rounded-lg md:rounded-xl font-semibold text-base md:text-lg transition-all duration-300 transform hover:scale-105 shadow-lg">
                      Book {{ tab.name }} Now
                    </button>
                  </div>
                </div>
      ...
      <section class="py-8 md:py-16 bg-gray-50">
        <div class="container mx-auto px-4">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-10 gap-6 md:gap-8 max-w-6xl mx-auto">
            ...
            <div class="lg:col-span-3 bg-white rounded-lg shadow-md p-3 md:p-4 h-full flex items-center justify-center">
              <div class="relative w-full h-64 md:h-80 lg:h-96 bg-blue-50 rounded-lg overflow-hidden">
                ...
                <iframe
                  ...
                  title="Map showing Gatwick Airport location">
                </iframe>
              </div>
            </div>
            ...
            <div class="lg:col-span-7 bg-white rounded-lg shadow-md p-4 md:p-6">
              ...
              <div class="flex flex-wrap space-x-1 mb-4 md:mb-6 bg-gray-100 rounded-lg p-1">
                <button v-for="tab in ['popular', 'london', 'coast', 'all']" :key="tab" @click="activeTab = tab" :class="[
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 md:gap-4">
                ...
                <div v-for="city in cityDestinations[activeTab]" :key="city.name"
                  class="p-2 md:p-3 flex items-center space-x-2 hover:bg-amber-50 rounded-md transition-colors group">
                  <div
                    class="w-6 h-6 md:w-8 md:h-8 bg-amber-100 rounded-full flex items-center justify-center text-amber-500 group-hover:bg-amber-200 flex-shrink-0">
              ...
              <div class="mt-4 md:mt-6 text-center">
                <button
                  class="inline-flex items-center font-medium text-amber-500 hover:text-amber-600 font-inter text-sm md:text-base">
                  See all destinations
                  <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 md:h-5 md:w-5 ml-1" viewBox="0 0 20 20"
                    fill="currentColor">
                    <path fill-rule="evenodd"
          ...
          <!-- Call to Action -->
          <div
            class="mt-8 md:mt-12 bg-gradient-to-r from-amber-500 to-amber-600 rounded-lg shadow-lg p-6 md:p-8 max-w-5xl mx-auto">
            <div class="flex flex-col md:flex-row items-center justify-between">
              <div class="mb-4 md:mb-0 md:mr-6">
                <h3 class="text-white text-xl md:text-2xl font-bold mb-2 font-sora">Need a custom destination?</h3>
              ...
              <div class="flex-shrink-0">
                <a href="/contact-us"
                  class="inline-block bg-white text-amber-600 hover:bg-amber-50 px-4 md:px-6 py-2 md:py-3 rounded-md font-semibold font-sora transition-colors shadow-md text-sm md:text-base">
                  Get Your Quote
                </a>
              </div>
            </div>
      ...
      <section class="py-16 bg-blue-50">
        <div class="container mx-auto px-4">
          <h2 class="text-3xl font-bold text-center mb-8 font-sora text-blue-900">Price Guide for Gatwick Airport</h2>
          <p class="text-gray-600 text-center max-w-3xl mx-auto mb-10 font-inter">
            Check our competitive pricing for popular destinations to and from Gatwick Airport.
            All prices shown are starting prices for a standard saloon car with up to 4 passengers.
          </p>

          <!-- Price Table -->
          <div class="max-w-4xl mx-auto bg-white rounded-lg overflow-hidden shadow-lg">
            <!-- Table Header -->
            <div class="grid grid-cols-3 bg-blue-100 p-4 font-semibold text-blue-900 font-sora">
              <div class="col-span-1 px-4">From</div>
              <div class="col-span-1 px-4">To</div>
              <div class="col-span-1 px-4 text-right">Prices from</div>
            </div>
            ...
            <div class="divide-y divide-gray-200">
              ...
              <div class="grid grid-cols-3 p-4 hover:bg-gray-50">
                <div class="col-span-1 px-4 font-inter">Gatwick Airport</div>
                <div class="col-span-1 px-4 font-inter">Piccadilly Circus</div>
                <div class="col-span-1 px-4 text-right font-semibold font-sora text-blue-900">£89</div>
              </div>

              <!-- Row 2 -->
              <div class="grid grid-cols-3 p-4 hover:bg-gray-50">
                <div class="col-span-1 px-4 font-inter">Gatwick Airport</div>
                <div class="col-span-1 px-4 font-inter">
                  <span class="text-blue-600 font-medium">Liverpool</span> Street rail station
                </div>
                <div class="col-span-1 px-4 text-right font-semibold font-sora text-blue-900">£84</div>
              </div>

              <!-- Row 3 -->
              <div class="grid grid-cols-3 p-4 hover:bg-gray-50">
                <div class="col-span-1 px-4 font-inter">Gatwick Airport</div>
                <div class="col-span-1 px-4 font-inter">Brighton</div>
                <div class="col-span-1 px-4 text-right font-semibold font-sora text-blue-900">£74</div>
              </div>

              <!-- Row 4 -->
              <div class="grid grid-cols-3 p-4 hover:bg-gray-50">
                <div class="col-span-1 px-4 font-inter">Heathrow Airport</div>
                <div class="col-span-1 px-4 font-inter">Gatwick Airport</div>
                <div class="col-span-1 px-4 text-right font-semibold font-sora text-blue-900">£89</div>
              </div>
              ...
              <!-- Row 5 -->
              <div class="grid grid-cols-3 p-4 hover:bg-gray-50">
                <div class="col-span-1 px-4 font-inter">Notting Hill</div>
                <div class="col-span-1 px-4 font-inter">Gatwick Airport</div>
                <div class="col-span-1 px-4 text-right font-semibold font-sora text-blue-900">£86</div>
              </div>

              <!-- Row 6 -->
              <div class="grid grid-cols-3 p-4 hover:bg-gray-50">
                <div class="col-span-1 px-4 font-inter">Sevenoaks</div>
                <div class="col-span-1 px-4 font-inter">Gatwick Airport</div>
                <div class="col-span-1 px-4 text-right font-semibold font-sora text-blue-900">£80</div>
              </div>
            </div>

            <!-- Table Footer -->
            <div class="bg-gray-50 p-4 text-center text-sm text-gray-500 font-inter italic">
              Price last updated on 1st March 2025, average taken between January 2025 and February 2025
            </div>
          </div>

          <!-- Price Information -->
          <div class="max-w-4xl mx-auto mt-8 grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- Card 1 -->
            <div class="bg-white rounded-lg p-6 shadow-md">
              <div class="text-center mb-4">
                <div class="inline-block bg-blue-100 rounded-full p-3">
                ...
                <h3 class="text-xl font-semibold mt-3 font-sora">No Hidden Fees</h3>
              </div>
              <p class="text-gray-600 text-center font-inter">
                Our prices include all taxes, waiting time at airports, and flight monitoring. No surprises when you
            ...
            <div class="bg-white rounded-lg p-6 shadow-md">
              <div class="text-center mb-4">
                ...
                <h3 class="text-xl font-semibold mt-3 font-sora">Instant Quote</h3>
              </div>
              <p class="text-gray-600 text-center font-inter">
                Get an instant price quote for your specific journey using our online booking form at the top of this
                page. No commitment required.
              </p>
            </div>
          </div>
          ...
          <div class="text-center mt-10">
            <button
              class="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-md font-semibold font-sora transition-colors">
      ...
      <section class="py-16 bg-white">
        <div class="container mx-auto px-4">
          <h2 class="text-3xl font-bold text-center mb-12 font-sora">Frequently Asked Questions</h2>
          ...
          <div class="max-w-4xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div class="space-y-6">
                ...
                <div class="bg-gray-50 rounded-lg p-6 shadow-sm">
                  <h3 class="text-lg font-semibold mb-3 font-sora">How do I book a taxi from Gatwick?</h3>
                  <p class="text-gray-600 font-inter">
                    You can book a taxi through our website, mobile app, or by calling our 24/7 booking line.
                    We recommend booking in advance to ensure availability, especially during peak travel times.
                  </p>
                </div>

                <!-- FAQ Item 2 -->
                <div class="bg-gray-50 rounded-lg p-6 shadow-sm">
                  <h3 class="text-lg font-semibold mb-3 font-sora">What happens if my flight is delayed?</h3>
                  <p class="text-gray-600 font-inter">
                ...
                <!-- FAQ Item 3 -->
                <div class="bg-gray-50 rounded-lg p-6 shadow-sm">
                  <h3 class="text-lg font-semibold mb-3 font-sora">Do I need to pay in advance?</h3>
                  <p class="text-gray-600 font-inter">
                    For most bookings, you can pay the driver directly at the end of your journey using cash or card.
                    However, advance payment is required for certain long-distance journeys or special vehicle types.
                  </p>
                </div>
              </div>
              ...
              <div class="space-y-6">
                <!-- FAQ Item 4 -->
                <div class="bg-gray-50 rounded-lg p-6 shadow-sm">
                  <h3 class="text-lg font-semibold mb-3 font-sora">How do I know which type of taxi I need?</h3>
                  <p class="text-gray-600 font-inter">
                    Choose based on your group size and luggage requirements. For help deciding, you can contact our
                    customer service team who will recommend the best vehicle type for your specific needs.
                  </p>
                </div>
            ...
            <!-- More FAQs Button -->
            <div class="text-center mt-10">
              <a href="/contact-us#faq" class="inline-block text-amber-500 font-medium hover:underline font-inter">
      ...
      <section class="py-12 bg-amber-100">
        <div class="container mx-auto px-4 text-center">
          ...
          <p class="text-gray-700 mb-8 max-w-3xl mx-auto font-inter">
            ...
            Our professional drivers and well-maintained vehicles ensure a pleasant journey every time.
          </p>
          <div class="flex flex-wrap justify-center gap-4">
            <button class="bg-amber-400 hover:bg-amber-500 text-white px-6 py-3 rounded-md font-semibold font-sora">
              Book Now
            </button>
            <a href="/contact-us"
              class="bg-gray-600 hover:bg-gray-700 text-white px-6 py-3 rounded-md font-semibold font-sora">
              Contact Us
            </a>
          </div>
        </div>
...
// City data organized by category
